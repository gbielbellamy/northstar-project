  ...
  "roadmap": [
    {
      ...
      "start": "2026-08-03",
      "end": "2026-08-09",
      "theme": "Sample week — data model and CRUD",
      ...
      "status": "Not started",
      "notes": "Sample data — replace with your own plan."
    },
    {
      "id": "rw-002",
      "week": 2,
      "start": "2026-08-10",
      "end": "2026-08-16",
      "theme": "Sample week — authentication",
    ...
    },
    {
      ...
      "start": "2026-08-17",
      "end": "2026-08-23",
      "theme": "Sample week — authorization and hardening",
    ...
    },
    {
      ...
      "start": "2026-08-31",
      "end": "2026-09-06",
      "theme": "Sample week — error handling",
    ...
    },
    {
      ...
      "start": "2026-09-07",
      "end": "2026-09-13",
      "theme": "Sample week — search, filters and metrics",
    ...
    },
    {
      ...
      "start": "2026-09-21",
      "end": "2026-09-27",
      "theme": "Sample week — containers and CI",
    ...
    },
    {
      ...
      "start": "2026-10-05",
      "end": "2026-10-11",
      "theme": "Sample week — documentation and launch",
  ...
  "goals": [
    {
      ...
      "week": 1,
      "area": "Project",
      "title": "Sample goal — build this week's slice",
      "detail": "Example content. Break the week's theme into issues, work them one branch at a time, and open a pull request for each.",
    ...
    },
    {
      ...
      "week": 1,
      "area": "Job Search",
      "title": "Sample goal — five applications, one a day",
      "detail": "Example content. Search each morning, shortlist across both tracks, tailor the CV to the role, and send one outreach message per application.",
    ...
    },
    {
      ...
      "week": 1,
      "area": "Contributions",
      "title": "Sample goal — move one contribution forward",
      "detail": "Example content. Advance whatever is open by exactly one stage, from shortlisting a project through to a merged pull request.",
    ...
    },
    {
      ...
      "week": 1,
      "area": "Learning",
      "title": "Sample goal — two sessions from the skill path",
      "detail": "Example content. Take the next unfinished sessions in the skill this week points at, and write the exercise rather than only reading.",
    ...
    },
    {
      ...
      "week": 1,
      "area": "Algorithms",
      "title": "Sample goal — one chapter of practice",
      "detail": "Example content. Work the chapter's problems, writing your own attempt before reading the model solution.",
    ...
    },
    {
      ...
      "week": 1,
      "area": "Interview Prep",
      "title": "Sample goal — one answer, out loud",
      "detail": "Example content. Rehearse one interview question on camera, review the recording, and record a second take.",
    ...
    },
    {
      ...
      "week": 1,
      "area": "Portfolio",
      "title": "Sample goal — keep the shop window current",
      "detail": "Example content. Check the deployed app, README, links and profiles as a stranger would, and fix whatever is stale.",
    ...
    },
    {
      ...
      "week": 1,
      "area": "Review",
      "title": "Sample goal — close the week honestly",
      "detail": "Example content. Record what shipped with its evidence, the lesson, the blocker, and one thing that changes next week.",
  ...
  "schedule": [
    {
      ...
      "fromWeek": null,
      "toWeek": null,
      "sessionDone": "Example target. One application sent, plus a message to someone connected to it.",
      "steps": [
        "Example step. Spend the first half hour searching and log anything worth a shot.",
        "Example step. Pick one opening and note the requirements it repeats.",
        "Example step. Tailor the CV to those points instead of sending a generic one.",
        "Example step. Apply, log it, and set a follow-up date.",
        "Example step. Send one message to a person connected to the role."
      ]
    },
    {
      "id": "sb-mon-1245",
    ...
    },
    {
      ...
      "fromWeek": null,
      "toWeek": null,
      "sessionDone": "Example target. Today's work is committed, pushed, and the issue says where you got to.",
      "steps": [
        "Example step. Open the issue before writing any code.",
        "Example step. Branch off main, one branch per issue.",
        "Example step. Commit in small steps, each doing one thing.",
        "Example step. Open the pull request with context, approach and testing.",
        "Example step. Review your own diff, merge, and record the evidence."
      ]
    },
    {
      "id": "sb-mon-1530",
    ...
    },
    {
      ...
      "fromWeek": null,
      "toWeek": null,
      "sessionDone": "Example target. One session finished with its exercise written.",
      "steps": [
        "Example step. Take the next unfinished session in the current skill path.",
        "Example step. Work through the linked resource with the session goal in mind.",
        "Example step. Write the exercise yourself.",
        "Example step. Tick the session so the path stays honest."
      ]
    },
    {
      "id": "sb-mon-1700",
      ...
      "fromWeek": null,
      "toWeek": null,
      "sessionDone": "Example target. Spoken aloud and recorded, with one take listened back to.",
      "steps": [
        "Example step. Everything here happens out loud.",
        "Example step. Answer the question to camera without writing it first.",
        "Example step. Watch it back and note the hesitations.",
        "Example step. Record a second take fixing the worst of them."
      ]
    },
    {
      "id": "sb-tue-0900",
    ...
    },
    {
      ...
      "fromWeek": null,
      "toWeek": null,
      "sessionDone": "Example target. One stage of the contribution path moved forward.",
      "steps": [
        "Example step. Pick up the open contribution where you left it.",
        "Example step. Move it forward exactly one stage.",
        "Example step. Follow the project's own conventions, not your habits.",
        "Example step. Record the stage change and what you learned."
      ]
    },
    {
      "id": "sb-tue-1530",
    ...
    },
    {
      ...
      "fromWeek": null,
      "toWeek": null,
      "sessionDone": "Example target. One problem worked, your attempt written before the model answer.",
      "steps": [
        "Example step. Restate the problem in your own words.",
        "Example step. Write your own solution and state its complexity.",
        "Example step. Read the model answer and name the gap.",
        "Example step. Redo it from scratch and log the result."
      ]
    },
    {
      "id": "sb-tue-1700",
    ...
    },
    {
      ...
      "fromWeek": null,
      "toWeek": null,
      "sessionDone": "Example target. The shop window is current and anything stale is fixed.",
      "steps": [
        "Example step. Open the app and README as a stranger would.",
        "Example step. Check links, screenshots and profiles.",
        "Example step. Fix whatever is out of date today."
      ]
    },
    {
      "id": "sb-sat-1100",
      ...
      "fromWeek": null,
      "toWeek": null,
      "sessionDone": "Example target. The review is saved and next week's issues exist.",
      "steps": [
        "Example step. Check the prefilled counts against what you actually did.",
        "Example step. Write the lesson and the blocker.",
        "Example step. Compare with last week, not with your intentions.",
        "Example step. Decide one change and set up next week."
      ]
    }
  ],
  "applications": [
